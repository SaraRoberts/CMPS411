    ...
    public class DataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<StaffBio>().HasData(
                new StaffBio { StaffBioId = 1, Picture = "Placeholder", Bio = "Becky Smith is the owner of Keeping Safety Smart. With over 20 years of emergency/life saver teaching experience, Ms. Smith founded Keeping Safety Smart in 2015.", UserId = 1 },
                new StaffBio { StaffBioId = 2, Picture = "Placeholder", Bio = "Nicole Dufrene is our certified child passenger safety technician in the regional area.  Contact her via email at nicoledufrene0301@gmail.com to schedule a free car seat fitting.", UserId = 2 },
                ...
                new StaffBio { StaffBioId = 7, Picture = "Placeholder", Bio = "I am Staff 6!", UserId = 7 },
                new StaffBio { StaffBioId = 8, Picture = "Placeholder", Bio = "I am Staff 6!", UserId = 8 },
                new StaffBio { StaffBioId = 9, Picture = "Placeholder", Bio = "I am Staff 6!", UserId = 9 },
                new StaffBio { StaffBioId = 10, Picture = "Placeholder", Bio = "I am Staff 6!", UserId = 10 }
            );
