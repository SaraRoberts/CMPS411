...
namespace KSS.Migrations
{
    ...
    [Migration("20180913040908_seedDataChanges")]
            ...
            modelBuilder.Entity("KSS.Areas.Admin.Models.Course", b =>
                {
                    ...
                    b.HasData(
                        new { CourseId = 1, Book = false, Description = "CPR beginner class", Name = "CPR 101" },
                        new { CourseId = 2, Book = false, Description = "CPR advanced techniques", Name = "CPR 201", PrereqId = 1 },
                        new { CourseId = 3, Book = false, Description = "CPR master class", Name = "CPR 301", PrereqId = 2 },
                        new { CourseId = 4, Book = false, Description = "EMT beginner class", Name = "EMT 101" },
                        new { CourseId = 5, Book = false, Description = "EMT advanced techniques", Name = "EMT 201", PrereqId = 4 },
                        new { CourseId = 6, Book = false, Description = "EMT master class", Name = "EMT 301", PrereqId = 5 }
                    );
                });
            ...
            modelBuilder.Entity("KSS.Areas.Admin.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new { UserId = 1, Email = "admin@admin.com", FirstName = "Becky", LastName = "Smith", Password = "7oCz8BO1gO6z++/ixBB0yzos4mJDz34oPYH1Dy5qY40=", Phone = "1112223333", Role = "Admin", Salt = new byte[] { 243, 155, 200, 132, 242, 144, 69, 25, 1, 236, 23, 60, 64, 219, 160, 26 } },
                        new { UserId = 2, Email = "student1@student.com", FirstName = "Paul", LastName = "Dig", Password = "MMni4J9zvCBm09F93PfFxB+A6djU650hfrsDMJ/n9sA=", Phone = "1112223333", Role = "User", Salt = new byte[] { 169, 14, 240, 243, 197, 2, 224, 41, 97, 33, 220, 174, 255, 67, 99, 193 } },
                        new { UserId = 3, Email = "student2@student.com", FirstName = "Mike", LastName = "Waters", Password = "MMni4J9zvCBm09F93PfFxB+A6djU650hfrsDMJ/n9sA=", Phone = "1112223333", Role = "User", Salt = new byte[] { 169, 14, 240, 243, 197, 2, 224, 41, 97, 33, 220, 174, 255, 67, 99, 193 } },
                        new { UserId = 4, Email = "student3@student.com", FirstName = "Russel", LastName = "Chavers", Password = "MMni4J9zvCBm09F93PfFxB+A6djU650hfrsDMJ/n9sA=", Phone = "1112223333", Role = "User", Salt = new byte[] { 169, 14, 240, 243, 197, 2, 224, 41, 97, 33, 220, 174, 255, 67, 99, 193 } },
                        new { UserId = 5, Email = "student4@student.com", FirstName = "Sharon", LastName = "Manino", Password = "MMni4J9zvCBm09F93PfFxB+A6djU650hfrsDMJ/n9sA=", Phone = "1112223333", Role = "User", Salt = new byte[] { 169, 14, 240, 243, 197, 2, 224, 41, 97, 33, 220, 174, 255, 67, 99, 193 } },
                        new { UserId = 6, Email = "student5@student.com", FirstName = "Amy", LastName = "Hillbond", Password = "MMni4J9zvCBm09F93PfFxB+A6djU650hfrsDMJ/n9sA=", Phone = "1112223333", Role = "User", Salt = new byte[] { 169, 14, 240, 243, 197, 2, 224, 41, 97, 33, 220, 174, 255, 67, 99, 193 } },
                        new { UserId = 7, Email = "student6@student.com", FirstName = "Bill", LastName = "Everet", Password = "MMni4J9zvCBm09F93PfFxB+A6djU650hfrsDMJ/n9sA=", Phone = "1112223333", Role = "User", Salt = new byte[] { 169, 14, 240, 243, 197, 2, 224, 41, 97, 33, 220, 174, 255, 67, 99, 193 } },
                        new { UserId = 8, Email = "student7@student.com", FirstName = "Trenton", LastName = "Hillsong", Password = "MMni4J9zvCBm09F93PfFxB+A6djU650hfrsDMJ/n9sA=", Phone = "1112223333", Role = "User", Salt = new byte[] { 169, 14, 240, 243, 197, 2, 224, 41, 97, 33, 220, 174, 255, 67, 99, 193 } },
                        new { UserId = 9, Email = "student8@student.com", FirstName = "Colin", LastName = "Livers", Password = "MMni4J9zvCBm09F93PfFxB+A6djU650hfrsDMJ/n9sA=", Phone = "1112223333", Role = "User", Salt = new byte[] { 169, 14, 240, 243, 197, 2, 224, 41, 97, 33, 220, 174, 255, 67, 99, 193 } },
                        new { UserId = 10, Email = "student9@student.com", FirstName = "Babe", LastName = "Ruth", Password = "MMni4J9zvCBm09F93PfFxB+A6djU650hfrsDMJ/n9sA=", Phone = "1112223333", Role = "User", Salt = new byte[] { 169, 14, 240, 243, 197, 2, 224, 41, 97, 33, 220, 174, 255, 67, 99, 193 } },
                        new { UserId = 11, Email = "student10@student.com", FirstName = "Tim", LastName = "Hammond", Password = "MMni4J9zvCBm09F93PfFxB+A6djU650hfrsDMJ/n9sA=", Phone = "1112223333", Role = "User", Salt = new byte[] { 169, 14, 240, 243, 197, 2, 224, 41, 97, 33, 220, 174, 255, 67, 99, 193 } },
                        new { UserId = 12, Email = "student11@student.com", FirstName = "Gary", LastName = "Aimes", Password = "MMni4J9zvCBm09F93PfFxB+A6djU650hfrsDMJ/n9sA=", Phone = "1112223333", Role = "User", Salt = new byte[] { 169, 14, 240, 243, 197, 2, 224, 41, 97, 33, 220, 174, 255, 67, 99, 193 } },
                        new { UserId = 13, Email = "student12@student.com", FirstName = "Lucy", LastName = "Vilardo", Password = "MMni4J9zvCBm09F93PfFxB+A6djU650hfrsDMJ/n9sA=", Phone = "1112223333", Role = "User", Salt = new byte[] { 169, 14, 240, 243, 197, 2, 224, 41, 97, 33, 220, 174, 255, 67, 99, 193 } },
                        new { UserId = 14, Email = "student13@student.com", FirstName = "Tom", LastName = "Avers", Password = "MMni4J9zvCBm09F93PfFxB+A6djU650hfrsDMJ/n9sA=", Phone = "1112223333", Role = "User", Salt = new byte[] { 169, 14, 240, 243, 197, 2, 224, 41, 97, 33, 220, 174, 255, 67, 99, 193 } },
                        new { UserId = 15, Email = "student14@student.com", FirstName = "Amanda", LastName = "Catalonato", Password = "MMni4J9zvCBm09F93PfFxB+A6djU650hfrsDMJ/n9sA=", Phone = "1112223333", Role = "User", Salt = new byte[] { 169, 14, 240, 243, 197, 2, 224, 41, 97, 33, 220, 174, 255, 67, 99, 193 } },
                        new { UserId = 16, Email = "student15@student.com", FirstName = "Donald", LastName = "Hill", Password = "MMni4J9zvCBm09F93PfFxB+A6djU650hfrsDMJ/n9sA=", Phone = "1112223333", Role = "User", Salt = new byte[] { 169, 14, 240, 243, 197, 2, 224, 41, 97, 33, 220, 174, 255, 67, 99, 193 } },
                        new { UserId = 17, Email = "student16@student.com", FirstName = "Richard", LastName = "Newman", Password = "MMni4J9zvCBm09F93PfFxB+A6djU650hfrsDMJ/n9sA=", Phone = "1112223333", Role = "User", Salt = new byte[] { 169, 14, 240, 243, 197, 2, 224, 41, 97, 33, 220, 174, 255, 67, 99, 193 } }
                    );
                });
